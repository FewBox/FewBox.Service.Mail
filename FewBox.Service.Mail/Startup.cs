        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOpenApiDocument(config =>
            {
                config.PostProcess = document =>
                {
                    ...
                    document.Info.Title = "FewBox log Api";
                    document.Info.Description = "FewBox log, for more information please visit the 'https://fewbox.com'";
                    ...
                    document.Info.License = new NSwag.SwaggerLicense
                    {
                        ...
                        Url = "https://raw.githubusercontent.com/FewBox/FewBox.Service.Log/master/LICENSE"
                    };
                };
